...
userSchema.methods.getTierLimits = function () {
  const tierLimits = {
    ...
    starter:    { name: 'Starter',    maxTransactionsPerMonth: 10, maxTransactionAmount: { USD: 2000,   NGN: 3000000   }, escrowFee: { USD: 0.035, NGN: 0.035 }, disputeResolution: false, prioritySupport: false, apiAccess: false, multiPartyEscrow: false, milestonePayments: false },
