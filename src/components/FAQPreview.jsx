...
const FAQPreview = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Fees are deducted when the escrow is funded and range from 1.5–5% depending on your plan. Free: 5%, Basic: 3%, Pro: 2%, Enterprise: 1.5%. No hidden charges ever.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Our dispute resolution team reviews all evidence and makes a fair decision within 24–48 hours. Both parties can submit proof through the dashboard.'
    },
    {
    ...
    <section id="faq" className="py-20 bg-white dark:bg-[#0f1419] transition-colors duration-300">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div
                className={`bg-[#f8fafc] dark:bg-[#1e2936] rounded-xl border-2 transition-all duration-300 overflow-hidden ${
                  openIndex === index
                    ? 'border-[#1e3a5f] dark:border-blue-600 shadow-lg'
              ...
              >
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-6 h-6 text-[#1e3a5f] dark:text-blue-400 flex-shrink-0 transition-transform duration-300 ${
        ...
        >
          ...
          {/* ✅ FIXED: was bare <button> with no navigation → <Link to="/contact"> */}
          <Link
            to="/contact"
            className="inline-block px-8 py-3 bg-[#1e3a5f] dark:bg-blue-700 text-white rounded-xl font-semibold hover:bg-[#2d4a7c] dark:hover:bg-blue-600 transition-all duration-200 shadow-lg"
          >
            Contact Support
          </Link>
        </motion.div>
