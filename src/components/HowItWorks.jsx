      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            <div className="bg-white dark:bg-gray-950 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-800 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                Secure and safe transactions protected by escrow.
              </p>
          ...
          >
            <div className="bg-white dark:bg-gray-950 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-800 hover:shadow-xl transition-all duration-300">
              {/* Icon */}
              <div className="w-20 h-20 bg-purple-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
                <svg className="w-10 h-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                Funds released when all terms are met and both parties agree.
              </p>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-500">Transaction ongoing</div>
                  </div>
                </div>
        ...
        <div className="text-center mt-12">
          <button
            ...
            className="px-10 py-4 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 transition-all duration-200 text-lg inline-flex items-center gap-2 shadow-lg"
          >
            Get Started Now
          </button>
        </div>
