...
const paymentMethods = [
  ...
  },
  {
    icon: '🌍',
    title: 'Flutterwave',
    description: 'Multi-currency, global cards',
    badge: 'International',
  ...
  },
  {
    ...
    description: 'BTC, ETH, USDT, USDC & more',
    badge: 'via NowPayments',
    badgeColor: 'bg-yellow-100 dark:bg-yellow-900/40 text-yellow-700 dark:text-yellow-400',
  },
  {
    icon: '💰',
    title: 'Dealcross Wallet',
    description: 'Instant from your balance',
    badge: 'Zero fees',
  ...
  },
  {
    icon: '🏦',
    title: 'Bank Transfer',
    description: 'NGN direct bank payment',
    badge: 'NGN',
    badgeColor: 'bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-400',
  },
  {
    ...
    badge: 'Global',
    badgeColor: 'bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-400',
  },
];
            ...
            >
              <div className="h-full bg-gray-50 dark:bg-gray-900 rounded-2xl p-4 sm:p-5 text-center border-2 border-gray-200 dark:border-gray-800 hover:border-blue-500 dark:hover:border-blue-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col items-center gap-3">
                ...
                <div className="flex-1 flex flex-col items-center gap-1.5">
                  ...
                  <span className={`inline-block text-[10px] sm:text-xs font-semibold px-2 py-0.5 rounded-full mt-1 ${method.badgeColor}`}>
                    {method.badge}
                  </span>
                </div>
              </div>
